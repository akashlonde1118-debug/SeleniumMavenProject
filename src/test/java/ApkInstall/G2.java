...
public class G2 {
	...
	//WebElement img = driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" + ".scrollIntoView(new UiSelector().text(\"Party dresses\"));"));
	//driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).setHorizontalList().scrollIntoView(new UiSelector().text(\"Midi\"));"));
