...
DesiredCapabilities capabilities = new DesiredCapabilities();
	...
	WebElement img = driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" + ".scrollIntoView(new UiSelector().text(\"Images\").instance(1));"));
	Thread.sleep(10000);
	
	Assert.assertTrue(driver.findElement(By.xpath("//android.widget.Button[@text=\"Images\"]")).isDisplayed());
